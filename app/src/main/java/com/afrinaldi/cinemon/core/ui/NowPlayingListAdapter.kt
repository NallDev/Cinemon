...
class NowPlayingListAdapter(private val data: List<ResultsItemNowPlaying>,
                            private val listener: (ResultsItemNowPlaying) -> Unit) : RecyclerView.Adapter<NowPlayingListAdapter.ViewHolder>() {
